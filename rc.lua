...
local myawesomemenu = {
    ...
    { "edit config", terminal.." emacs /home/dt/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
    { "restart", awesome.restart },
}

awful.util.mymainmenu = freedesktop.menu.build({
    icon_size = beautiful.menu_height or 15,
    before = {
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey}, "d",
    function ()
        awful.spawn(string.format("dmenu_run -i -nf '#fcfcfc' -nb '#292d3e' -sf '#fcfcfc' -sb '#0077bb' -p 'Run: '"))
	end,
    ...
    awful.key({ altkey, "Control"  }, "w", function () awful.util.spawn( "./.dmenu/dmenu-surfraw.sh" ) end,
    ...
    awful.key({ altkey, "Control"  }, "s", function () awful.util.spawn( "./.dmenu/dmenu-scrot.sh" ) end,
        {description = "Scrot" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control"  }, "r", function () awful.util.spawn( "./.dmenu/dmenu-reddio.sh" ) end,
        {description = "Reddit" , group = "dmenu scripts" }),

    -- My applications (Super+Key)
    awful.key({ modkey }, "F1", function () awful.util.spawn( "emacs --eval '(elfeed)'" ) end,
        {description = "Elfeed" , group = "terminal apps" }),
    awful.key({ modkey }, "F2", function () awful.util.spawn( myTerm.." -e alsamixer" ) end,
        {description = "Alsamixer" , group = "terminal apps" }),
    awful.key({ modkey }, "F3", function () awful.util.spawn( terminal.." -e ranger" ) end,
        {description = "Ranger" , group = "terminal apps" }),
    awful.key({ modkey }, "F4", function () awful.util.spawn( "emacs --eval '(dired nil)'" ) end,
        {description = "Dired Manager" , group = "terminal apps" }),
    awful.key({ modkey }, "F5", function () awful.util.spawn( terminal.." -e mocp" ) end,
        {description = "MOCP music player" , group = "terminal apps" }),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey,           }, "x", function () awful.spawn("lock") end,
              {description = "Lock Screen", group = "super"}),
    awful.key({ modkey,  "Control"}, "x", function () awful.spawn("xkill") end,
              {description = "xkill", group = "super"}),
    awful.key({ modkey, "Shift" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Shift"   }, "q",  function () awful.spawn.with_shell( 'prompt "Are you sure to Quit?" "killall awesome"' ) end,
              {description = "quit awesome", group = "awesome"}),
    awful.key({ modkey,  altkey   }, "q",  function () awful.spawn.with_shell( 'prompt "Are you sure to Shutdown?" "poweroff"' ) end,
...
client.connect_signal("mouse::enter", function(c)
    c:emit_signal("request::inactivate", "mouse_enter", {raise = true})
end)
